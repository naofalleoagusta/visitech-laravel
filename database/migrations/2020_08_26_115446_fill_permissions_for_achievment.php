...
class FillPermissionsForAchievment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAchievment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.achievment',
            'admin.achievment.index',
            'admin.achievment.create',
            'admin.achievment.show',
            'admin.achievment.edit',
            'admin.achievment.delete',
            'admin.achievment.bulk-delete',
        ]);
